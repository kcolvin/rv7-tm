# Main infinite loop program to ingest UDP messages from data radio.
...
#   - Updates a single entry in a DynamoDB table to be used by the RemoteServer API call
# 
import socket
import datetime
import time
...
while True:
    ...
    if new_gps_data:
        ...
        #print('DynamoDB Success: ',dynamo_response['ResponseMetadata']['RequestId'])
