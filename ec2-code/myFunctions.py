...
def parse_ems(ems_raw):
    ...
    # Elevator position is at GP Input #1: starts at 124 for 6 bytes
    # Format: +, 4 numbers, "T"
    elevatorPos = ems_raw[123:128] # Drop the "T" at the end
    #print(elevatorPos) 
    return [ts,oil_p,oil_t,rpm,mpress,elevatorPos]
...
def create_payload(adahrs_lst,lat,lon,gspd,magvar,elevatorPos):
    ...
    keys = ['aircraft','ts','lat','lon','palt','ias','baro','gspd','vs','pitch','roll','mh','flaps',
        'com1','com1standby','windspeed','winddir','magvar','agl','elevatorPos']
    #print(keys)
    ...
    values.append(elevatorPos)      # elevatorPos
    #print(values)
